...
export default function HeroBackground() {
 ...
 {/* Soft green glow accents for premium feel */}
 <div className="absolute top-0 left-1/4 w-96 h-96 bg-primary/12 rounded-full blur-3xl pointer-events-none" />
 <div className="absolute bottom-0 right-1/4 w-80 h-80 bg-accent-glow/10 rounded-full blur-3xl pointer-events-none" />
 </div>
 );
}
