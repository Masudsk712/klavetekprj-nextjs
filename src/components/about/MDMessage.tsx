...
export default function MDMessage() {
  ...
  return (
    <section
      className={`relative overflow-hidden ${bg} py-24 md:py-32 transition-colors duration-300`}
    >
      {/* ambient green glows */}
      ...
      <Container>
        ...
        >
          ...
          >
            <motion.span
              variants={reveal}
              className={`inline-flex items-center gap-3 text-xs font-semibold uppercase tracking-[0.28em] ${accent}`}
            >
              <span
            ...
            <motion.div variants={reveal} className="relative mt-8">
              ...
              <p
                className={`mt-4 text-2xl font-semibold leading-[1.35] tracking-tight md:text-[28px] ${titleColor}`}
              >
            ...
            <motion.p
              variants={reveal}
              className={`mt-7 max-w-xl text-base leading-[1.85] ${bodyColor}`}
            >
              {mdMessage.message}
            </motion.p>
            ...
            <motion.div
              variants={reveal}
              className={`mt-10 border-t pt-7 ${borderColor}`}
            >
              <div className={`text-lg font-semibold ${titleColor}`}>
                {managingDirector.name}
              </div>
              <div className={`mt-1 text-sm ${accent}`}>
                {managingDirector.position}
              </div>
              <div
                className={`mt-2 text-xs font-medium uppercase tracking-widest ${bodyColor}`}
              >
