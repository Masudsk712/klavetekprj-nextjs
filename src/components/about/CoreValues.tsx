...
import { Award, Leaf, Users, Lightbulb, Heart } from "lucide-react";
...
export default function CoreValues() {
 ...
 <SectionHeader title={coreValues.title} subtitle={coreValues.subtitle} />
 ...
 <h3 className="text-lg font-semibold text-[var(--heading)] mb-3">{value.title}</h3>
 <p className="text-sm text-[var(--muted-text)] leading-relaxed">{value.description}</p>
 </div>
 </GlassCard>
 </motion.div>
 ))}
