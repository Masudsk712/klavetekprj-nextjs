  ...
  hospitals: [
    {
      ...
      description: "A 200-bed multispeciality hospital constructed with Klavetek AAC blocks for fire resistance, acoustic comfort and hygienic surfaces.",
    ...
    },
    {
      ...
      description: "A dedicated nursing home in Malda built with Klavetek AAC blocks for patient comfort and a calm healing environment.",
    ...
    },
    {
      ...
      description: "A medical college and hospital in Kishanganj built with Klavetek AAC blocks for durable and fire-safe healthcare infrastructure.",
    ...
    },
    {
      ...
      description: "A modern nursing home in Malda built with Klavetek AAC blocks for comfort, hygiene and energy efficiency.",
    ...
    },
    {
      ...
      description: "A patient-centred nursing home built with Klavetek AAC blocks for a safe, comfortable and hygienic care environment.",
  ...
  "educational-institutions": [
    {
      ...
      description: "Growth Career Institute is built with Klavetek AAC blocks for safe, comfortable and energy-efficient learning spaces.",
  ...
  "commercial-buildings": [
    {
      ...
      description: "A commercial centre in Malda built with Klavetek AAC blocks for modern retail and business spaces.",
    ...
    },
    {
      ...
      description: "A premium commercial development in Malda built with Klavetek AAC blocks for modern business spaces.",
  ...
  "residential-buildings": [
    {
      ...
      description: "Riviera is a premium residential project in Purnia built with Klavetek AAC blocks for comfortable and durable living.",
  ...
  "industrial-projects": [
    {
      ...
      description: "Balurghat Railway Station was constructed with high-strength Klavetek AAC blocks for durable, large-span public infrastructure.",
