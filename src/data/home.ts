...
export const aboutPreview = {
  ...
  values: ["Commitment", "Honesty", "Dedication", "Professionalism", "Sustainability"],
...
export const manufacturingProcess = {
  ...
  subtitle: "Every Klavetek AAC Block passes through a fully automated, precision-controlled manufacturing process to ensure superior quality, strength, durability and consistency.",
  highlight: "Premium AAC Blocks",
  bottomStatement: "Every manufacturing stage is monitored under strict quality standards to deliver AAC Blocks that meet the highest level of strength, precision and reliability.",
  processTime: "10-12 Days",
  steps: [
  {
  step: "01",
  title: "Raw Material",
...
export const testimonials = {
  ...
  subtitle: "Trusted by leading builders, contractors, and developers across Eastern India.",
  items: [
  {
